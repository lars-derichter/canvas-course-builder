...
the accompanying blueprint is colleague-facing.
...
1. **Read the fixed inputs**: `course-context.md` — pedagogy, learning-goal
   ...
   save it back; `docs/style.md` — shared rules plus the student-facing section;
...
5. **Write the evaluation** to `evaluations/<year>/<slug>/instructions.md`,
   ...
   of `docs/style.md`; code in questions follows the course's code conventions
   from `course-context.md`.
