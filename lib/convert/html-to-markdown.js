 ...
 * @param {'page'|'assignment'|'discussion'|'external_url'|'external_tool'} canvasType - The Canvas item type.
 ...
 * @param {'page'|'assignment'|'discussion'|'external_url'|'external_tool'} canvasType
...
function getBodyHtml(item, canvasType) {
  ...
  // external_url and external_tool items are links: no HTML body of their own
  return '';
}
