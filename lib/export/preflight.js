...
const INSTALL_HINTS = {
  pandoc:
    ...
    '  Linux:   use your package manager (apt install pandoc) or see below\n' +
    '  Docs:    https://pandoc.org/installing.html',
  typst:
    'Install Typst (needed for PDF export):\n' +
...
async function preflight({ format = 'pdf', exec = defaultExec } = {}) {
  ...
  try {
    ...
    throw new Error(`pandoc was not found on your PATH.\n\n${INSTALL_HINTS.pandoc}`);
  }
