...
const { loadCourseConfig, DEFAULT_EXPORT_STYLE } = require('../config/course-config');
 ...
 */
function resolveAsset(filename, override, styleDir = resolveStyleDir(DEFAULT_EXPORT_STYLE)) {
